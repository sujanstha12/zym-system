...
@section('container')
    <div class="container mx-auto mt-10">
        ...
        <div class="bg-white p-6 rounded shadow-md max-w-xl mx-auto">
            ...
            <h3 class="text-xl font-semibold mb-2">{{ Auth::guard('customer')->user()->name }}</h3>
            ...
            <!-- Checkout form -->
            <form method="POST" action="{{ route('purchase.confirm', $product) }}">
                @csrf
                ...
                <div class="mt-4">
                    ...
                    <input type="number" id="quantity" name="purchased_quantity" value="1" min="1"
                ...
                {{-- <div class="mt-4">
                    ...
                    <input type="text" id="phone" name="phone" value="{{ Auth::guard('customer')->user()->phone_number }}" class="w-full px-3 py-2 border rounded" required>
                </div> --}}
